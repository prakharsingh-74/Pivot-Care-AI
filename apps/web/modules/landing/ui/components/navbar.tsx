...
const workflowItems = [
  {
    href: "/workflows/chat-support",
    label: "Chat Support",
    icon: MessageSquare,
  },
  {
    href: "/workflows/ticket-routing",
...
const toolsMenu = {
  free: [
    {
      ...
      items: [
        {
          href: "/tools/free/chat-widget",
          label: "Chat Widget",
          icon: MessageSquare,
        },
        {
          href: "/tools/free/response-templates",
    ...
    },
    {
      ...
      items: [
        {
          href: "/tools/free/basic-analytics",
          label: "Basic Analytics",
          icon: BarChart3,
        },
        {
          href: "/tools/free/satisfaction-surveys",
  ...
  paid: [
    ...
    },
    {
      ...
      items: [
        {
          href: "/tools/paid/workflow-automation",
          label: "Workflow Automation",
          icon: Zap,
        },
        {
          href: "/tools/paid/smart-escalation",
    ...
    },
    {
      ...
      items: [
        {
          href: "/tools/paid/proactive-chat",
          label: "Proactive Chat",
          icon: Megaphone,
        },
        {
          href: "/tools/paid/targeted-messages",
    ...
    },
    {
      ...
      items: [
        {
          href: "/tools/paid/sentiment-analysis",
          label: "Sentiment Analysis",
          icon: BarChart3,
        },
        {
          href: "/tools/paid/conversation-insights",
