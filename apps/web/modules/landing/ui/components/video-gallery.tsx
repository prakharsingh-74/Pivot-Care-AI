  ...
  return (
    ...
    >
      ...
      >
        ...
        <path
          d="M190 112 L195 105 L205 105 L210 112 L205 119 L195 119 Z"
          fill="oklch(0.08 0 0)"
        />
...
const demos = [
  {
    ...
    description: "See Pivot Care AI handle real customer inquiries",
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold tracking-display mb-4">
            See <span className="text-gradient-lime">Pivot Care AI</span> in
            action
          </h2>
